...
parser.add_argument('--BATCH_NORM', default = 1)
        ...
        while True:
            ...
            while(not terminal):
                ...
                if(len(memory) >= TRAIN_ON_SIZE):
                    ...
                    q_network.fit(states, None, targets, epochs = 1, batch_size = TRAIN_BATCH_SIZE)
